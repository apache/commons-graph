...
/**
 * Contains the Floyd–Warshall's shortest path algorithm implementation.
 */
public final class FloydWarshall
{
    ...
    /**
     * Applies the classical Floyd–Warshall's algorithm to find the shortest path from the source to the target, if exists.
     *
